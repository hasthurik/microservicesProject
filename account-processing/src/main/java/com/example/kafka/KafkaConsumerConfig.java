...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConsumerFactory<String, ClientProductDto> productConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, ClientProductDto> productKafkaListenerContainerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CardRequestDto> cardKafkaListenerContainerFactory() {
